...
namespace CMPG323_Project2__33574359.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class CustomersController : ControllerBase
    {
        private readonly cmpg323_project2_databaseContext _context;

        public CustomersController(cmpg323_project2_databaseContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Customer>> PostCustomer(Customer customer)
        {
          if (_context.Customers == null)
          {
              return Problem("Entity set 'cmpg323_project2_databaseContext.Customers'  is null.");
          }
